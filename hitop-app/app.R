              ...
              tabPanel("About", br(),
                       ...
                       div(class = "card",
                           ...
                           p("Scores are shown as T-scores (mean: 50, SD: 10) relative to ",
                             ...
                             "percentile-based norms are planned to replace them. Error bars ",
                             "show \u00B11 standard error of the person\u0027s own item ",
                             "responses within each scale \u2014 an index of response ",
                             "consistency, not the standard error of measurement; a ",
                             "reliability-based interval is planned to replace it."),
                           ...
                           fluidRow(
                             ...
                             column(4, style = "text-align:right;padding-top:24px;",
                                    checkboxInput("show_err",
                                                  "Error bars (\u00B11 SE of item-response mean)", TRUE),
