...
ui <- fluidPage(
  ...
  div(class = "app-header",
      ...
      h2("HiTOP-SR Scoring",
         span("* v0.2.0-alpha version, feedback is much appreciated",
      ...
      div(class = "card",
        ...
        p("Scores are shown as T-scores (mean: 50, SD: 10) relative to ",
          ...
          if (hitop_has_intervals) paste0(
            ...
            "minimum possible score, and the charts extend their axis to ",
            "show it, with a dashed line marking the response floor. The ",
            "stated coverage applies across respondents drawn from the ",
      ...
      div(class = "card",
        ...
        if (hitop_has_intervals)
          conditionalPanel("input.show_err", div(class = "anchor-note",
            ...
            "scores. Where an interval reaches below the lowest possible ",
            "score, the axis widens to show it and a dashed line marks ",
            "the true minimum. The 95% describes accuracy across many ",
            "people from that sample, not a guarantee for any one person.")),
        div(class = "anchor-note",
